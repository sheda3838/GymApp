...
namespace GymSample2
{
    public partial class TrainersHomePage : Form
    {
        ...
        private void viewprofilebtn_Click(object sender, EventArgs e)
        {
            ...
            Trainer trainerDetails = Trainer.GetTrainerDetails(userName);
            ...
            {
                MessageBox.Show("An Error Occured!! User Details Not Found!!!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            List<Classes> classesList = Classes.GetClassesByTrainerID(Trainer.LoggedInTrainerID);
