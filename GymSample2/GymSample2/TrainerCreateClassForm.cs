...
namespace GymSample2
{
    public partial class TrainerCreateClassForm : Form
    {
        ...
        private void submitbtn_Click(object sender, EventArgs e)
        {
            ...
            if (!Classes.IsTrainerAvailableOnDate(Trainer.LoggedInTrainerID, date))
            {
            ...
            bool isCreated = Classes.CreateClass(className, description, Trainer.LoggedInTrainerID, date, maxParticipants);
