...
namespace GymSample2
{
    public partial class TrainerUpdateProfileForm : Form
    {
        ...
        private void UpdateTrainerForm_Load(object sender, EventArgs e)
        {
            ...
            Trainer trainer = Trainer.GetTrainerDetails(loggedinusername);
        ...
        private void updatebtn_Click(object sender, EventArgs e)
        {
            ...
            bool isUpdated = Trainer.UpdateTrainer(Trainer.LoggedInTrainerUserName, updatedName, updatedEmail, updatedAge, updatedPhoneNumber, updatespecialization);
