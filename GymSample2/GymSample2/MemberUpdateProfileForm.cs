...
namespace GymSample2
{
    public partial class MemberUpdateProfileForm : Form
    {
        ...
        private void UpdateMemberForm_Load(object sender, EventArgs e)
        {
            ...
            Member member = Member.GetMemberDetails(loggedInUserName);
        ...
        private void updatebtn_Click(object sender, EventArgs e)
        {
            ...
            bool isUpdated = Member.UpdateMember(Member.LoggedInMemberUserName, updatedName, updatedEmail, updatedAge, updatedPhoneNumber, updatedMembershipType);
