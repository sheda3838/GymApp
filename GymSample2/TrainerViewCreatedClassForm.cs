...
namespace GymSample2
{
    public partial class TrainerViewCreatedClassForm : Form
    {
        ...
        private void ViewTrainerClassForm_Load(object sender, EventArgs e)
        {
            ...
            classesList = ClassManager.GetClassesByTrainerID(Trainer.LoggedInTrainerID);
        ...
        {
            var confirmation = MessageBox.Show("Are you sure you want to Delete this class", "Delete Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);

            if (confirmation == DialogResult.Yes)
            {
                bool isDeleted = ClassManager.DeleteClass(currentClassID);
