...
namespace GymSample2
{
    public partial class MemberAttendanceForm : Form
    {
        ...
        private void MemberAttendanceForm_Load(object sender, EventArgs e)
        {
            ...
            List<Attendance> attendanceHistory = AttendanceManager.GetMemberAttendance(memberID);
            ...
            {
                if (attendanceHistory == null || attendanceHistory.Count == 0)
                {
        ...
        {
            MemberViewProfileForm profileForm = new MemberViewProfileForm();
            profileForm.Show();
            this.Hide();
        }
