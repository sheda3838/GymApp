...
namespace GymSample2
{
    public partial class MemberJoinClassesForm : Form
    {
        ...
        private void MemberViewAllClassesForm_Load(object sender, EventArgs e)
        {
            ...
            classesList = ClassManager.GetAllClasses();
        ...
        private void DisplayClass(int index)
        {
            ...
            if (index >= 0 && index < classesList.Count)
            {
                ...
                bool isEnrolled = ClassManager.IsMemberEnrolledInClass(Member.LoggedInMemberID, availableclass.ClassID);
        ...
        {
            ClassManager.JoinClass(currentClassID, Member.LoggedInMemberID);
            DisplayClass(currentClassIndex);
        ...
        private void submitbtn_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtTrainerID.Text, out trainerID))
            {
                ...
                classesList = ClassManager.GetClassesByTrainerID(trainerID);
        ...
        {
            List <Classes> userclassesList = ClassManager.GetClassesByUserID(Member.LoggedInMemberID);
        ...
        {
            bool isDeleted = ClassManager.DeleteMemberFromClass(currentClassID, Member.LoggedInMemberID);
